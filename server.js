...
var questions = [{type: 'normal', title: 'Klassuppgift', no_number: true, answer_type: 'practical', image: 'images/trebuchet.jpg', leftText: '<p style="color: red;">Vad ska stå här? Hur lång tid? Poäng? Maxpoäng?</p>', rightText: '', timeText: '1 minut', scoringText: '4 poäng per träff', maxScoringText: '40 poäng', time: 10, slides: ['<p style="color: red;">Vad ska stå här? Hur lång tid? Poäng? Maxpoäng?</p>']},
                 ...
                 {type: 'normal', title: 'Allfix', answer_type: 'pairing', pairs: [['<img src="images/tvatt.png" height="80">','<img src="images/symaskin.png" height="80">','<img src="images/cykel.png" height="80">','<img src="images/hogtalare.jpg" height="80">','<img src="images/dator.png" height="80">'],['<img src="images/zipper.jpg" height="80">', '<img src="images/propp.jpg" height="80">', '<img src="images/hdd.png" height="80">', '<img src="images/water.jpg" height="80">', '<img src="images/kil.jpg" height="80">', '<img src="images/kedjespannare.jpg" height="80">', '<img src="images/hogtalare1.jpg" height="80">', '<img src="images/snowboard_pjaxa.png" height="80">', '<img src="images/spole.jpg" height="80">', '<img src="images/tandstift.png" height="80">']], image: 'images/allfix.jpg', leftText: '<p>Ni praktiserar på lagret hos ALLFIX - firman som fixar allt!</p><p>Några kunder kommer in med sina trasiga produkter och ni ska ta fram rätt reservdel från lagret. Para ihop rätt reservdel med rätt produkt! Tänk på att alla reservdelar i lagret inte ska användas, men alla produkter behöver såklart lagas, för ni fixar ALLT!</p><p>Para ihop rätt reservdel med rätt produkt genom att dra reservdelen.</p>', rightText: '<p><img src="images/reservdelar.png" width="100%"></p>', timeText: '2 minuter', scoringText: '1 poäng per rätt par', maxScoringText: '5 poäng', time: 2*60, slides: ['<p>Ni praktiserar på lagret hos ALLFIX - firman som fixar allt!</p><p>Några kunder kommer in med sina trasiga prylar och ni ska ta fram rätt reservdel från lagret.</p><p>Para ihop rätt reservdel med rätt produkt! </p><p>Tänk på att alla reservdelar i lagret inte ska användas, men alla produkter behöver såklart lagas, för ni fixar ALLT!</p>','<p><img src="images/reservdelar.png" width="60%"></p>'], answer: '<p><img src="images/allfix_facit.png"></p>'},
